      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '16px' }}>
        <button
          ...
          style={{
            ...
            backgroundColor: role === 'user' ? 'var(--color-primary-subtle)' : 'var(--color-bg-card)',
            color: role === 'user' ? 'var(--color-primary)' : 'var(--color-text-body)',
            fontWeight: 600,
        ...
        <button
          ...
          style={{
            ...
            backgroundColor: role === 'restaurant_owner' ? 'var(--color-primary-subtle)' : 'var(--color-bg-card)',
            color: role === 'restaurant_owner' ? 'var(--color-primary)' : 'var(--color-text-body)',
            fontWeight: 600,
            fontSize: 'var(--font-size-sm)',
          }}
        >
